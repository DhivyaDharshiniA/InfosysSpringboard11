...
const Dashboard = ({ userid }) => {
  ...
  const calculateScore = () => {
    ...
    setScore(((gainedscore / (questions.length * 15)) * 100).toFixed(0));
  };
      ...
      <header className="header">
        ...
        <nav>
          <ul className="nav-links">
            ...
            <li><a href="#Emergency" onClick={() => setCurrentPage("Emergency")}>Emergency</a></li>
            <li><a href="#recommendations" onClick={() => setCurrentPage("ChatBot")}>Recommendations</a></li>
          </ul>
        </nav>
      </header>
      <main className="main-content">
        <div className="welcome-card">
          <div className="card-content">
            ...
            <button onClick={() => setCurrentPage("assessment")} className="primary-button">Begin Assessment</button>
            ...
            {questions[currentQuestion]?.choices.map((choice, index) => (
              <div key={index} className="option-item">
                <input
                  ...
                  onChange={() => handleAnswer(choice.score, choice.option, questions[currentQuestion]?.questionText)}
                />
            ...
            <div className="recommendation-cards">
              {score >= 75 ? (
                ...
                <div className="recommendation-card">
                  ...
                  <p>Consider adding self-care practices to strengthen your resilience</p>
                </div>
              ) : (
                <div className="recommendation-card">
                  <h4>Seek Support</h4>
                  <p>Explore additional mental health resources for better coping strategies</p>
                </div>
              )}
            </div>
          </div>
  ...
  return (
    <>
      ...
      <div id="chatbot-toggle" className="chatbot-toggle-logo" onClick={toggleChatbot}>
        <img src="https://img.freepik.com/free-vector/chatbot-chat-message-vectorart_78370-4104.jpg" alt="Chatbot Logo" className="chatbot-logo" />
      </div>
